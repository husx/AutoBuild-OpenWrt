...
- [Lede_source](https://github.com/coolsnowwolf/lede)源码，Luci版本=18.06、内核版本=5.10
- [Lienol_source](https://github.com/Lienol/openwrt/tree/19.07)源码，Luci版本=17.01、内核版本=4.14
- [Mortal_source](https://github.com/immortalwrt/immortalwrt/tree/openwrt-21.02)源码，Luci版本=21.02、内核版本=5.4
- [openwrt_amlogic](https://github.com/coolsnowwolf/lede)源码，N1和晶晨系列CPU盒子专用（Luci版本=18.06、内核版本=5.4）
